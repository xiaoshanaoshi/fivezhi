...
<title>功能介绍|<?php echo C('site_name');?>|<?php echo C('site_title');?></title>
	...
	<div class="nav-content">
		...
		<div class="right line-li">
			<ul>
				...
				<li>
					<a href="<?php echo U('Home/Index/gongneng');?>" class="hover">功能介绍</a>
				</li>
				<li>
...
<div class="Public-content clearfix" style="margin-top:38px;">
	<div class="Public">
		<h1 class="Public-h2">功能介绍</h1>
		<div class="Public-box clearfix">
			<ul id="nav_lis" class="case-nav left">
				<li data-index="0" data-hash="#site" class="hover">微官网</li>
				<li data-index="1" data-hash="#member" class="">微会员</li>
				<li data-index="2" data-hash="#activities" class="">微活动</li>
				<li data-index="3" data-hash="#push" class="">微推送</li>
				...
				<li data-index="9" data-hash="#addup" class="">微统计</li>
				<li data-index="10" data-hash="#estate" class="">微房产</li>
				<li data-index="11" data-hash="#car" class="">微汽车</li>
				<li data-index="12" data-hash="#wedd" class="">微喜帖</li>
				<li data-index="13" data-hash="#medical" class="">微医疗</li>
				<li data-index="14" data-hash="#hotels" class="">微酒店</li>
				<li data-index="15" data-hash="#lbs" class="">LBS图文回复</li>
                <li data-index="16" data-hash="#" class="">微餐饮</li>
				<li data-index="17" data-hash="#" class="">微商城</li>
                <li data-index="18" data-hash="#reser" class="">微预约</li>
			</ul>
			<div id="nav_uls">
				<div data-index="0" data-on="" class="weimob_guide right show">
					<div class="wm_case_list">
						<h2 class="guideh2">微官网:快速帮用户打造超炫微信移动网站</h2>
						<p class="guideimg"><img src="<?php echo RES;?>/weimob1.jpg"></p>
				...
				<div data-index="1" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob2.jpg"></p>
				...
				<div data-index="2" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob3.jpg"></p>
				...
				<div data-index="3" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob4.jpg"></p>
				...
				<div data-index="4" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob5.jpg"></p>
				...
				<div data-index="5" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob6.jpg"></p>
				...
				<div data-index="6" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob7.jpg"></p>
				...
				<div data-index="7" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob8.jpg"></p>
				...
				<div data-index="8" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob9.jpg"></p>
				...
				<div data-index="9" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob10.jpg"></p>
				...
				<div data-index="10" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob11.jpg"></p>
				...
				<div data-index="11" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob12.jpg"></p>
				...
				<div data-index="12" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob13.jpg"></p>
				...
				<div data-index="13" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob14.jpg"></p>
				...
				<div data-index="14" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob15.jpg"></p>
                ...
                <div data-index="15" class="weimob_guide right">
					<div class="wm_case_list">
						<h2 class="guideh2">LBS回复:LBS范围内精准的商家地理位置回复</h2>
							<p class="guideimg"><img src="<?php echo RES;?>/weimob16.jpg"></p>
				...
				<div data-index="16" class="weimob_guide right">
					<div class="wm_case_list">
                        ...
                        <p class="guideimg"><img src="<?php echo RES;?>/weimob17.jpg"></p>
						<p class="guidep"><?php echo C('site_name');?>后台可以实时统计微信公众号的粉丝关注情况和用户语音请求数，根据统计对相关推广营销活动效果及某些敏感因素对您的影响作出判断，并对相关市场行为作出相应调整，从一定程度上实现了对市场的监控与及时应对。</p>
					</div>
				</div>
				<div data-index="17" class="weimob_guide right">
					<div class="wm_case_list">
                        ...
                        <p class="guideimg"><img src="<?php echo RES;?>/weimob18.jpg"></p>
						<p class="guidep">“微商城”（又名Vshop）是由微商家推出的，一款基于移动互联网的商城应用服务产品，以时下最热门的互动应用微信为媒介，配合微信5.0微信支付功能，实现商家与客户的在线互动，即时推送最新商品信息给微信用户，实现微信在线的购物功能。
                ...
                <div data-index="18" class="weimob_guide right">
					<div class="wm_case_list">
						...
						<p class="guideimg"><img src="<?php echo RES;?>/weimob19.jpg"></p>
