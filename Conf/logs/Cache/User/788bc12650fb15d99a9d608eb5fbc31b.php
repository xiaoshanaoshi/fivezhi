...
<iframe id="frame" width= "100%" height="1000" ></iframe>
<script  type="text/JavaScript">
	...
	var get_id = $_GET['id']?$_GET['id']:'new';
      document.getElementById("frame").src="http://3.com/xiumi/xiumi.us/studio/paper.html#/for/"+get_id;
</script>